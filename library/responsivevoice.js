...
(function (w, y) {
  ...
  function y(C, p) {
    ...
    "string" === typeof p
      ...
      : p instanceof Blob &&
        p.type &&
        q.setRequestHeader("Content-Type", p.type);
    try {
      q.send(p);
    } catch (z) {
      return !1;
  ...
  (function () {
    ...
    "function" !== typeof this.navigator.sendBeacon &&
      (this.navigator.sendBeacon = y.bind(this));
  }.call(
          ...
          for (var h = 0; h < q.length; h++) {
            ...
            k
              ? (Array.isArray(k) || (k = [k]),
                c.collectionvoice &&
                  ...
                  -1 != k.indexOf(c.collectionvoice.name) &&
                  (g = !0))
              : (g = !0);
            var f = !1,
              l = e.systemvoices;
            l
              ? (Array.isArray(l) || (l = [l]),
                c.systemvoice &&
                  c.systemvoice.name &&
                  -1 != l.indexOf(c.systemvoice.name) &&
                  (f = !0))
              : (f = !0);
            (null == k || (null != k && g)) &&
              (null == l || (null != l && f)) &&
              ...
              if (b.length > a.CHARACTER_LIMIT) {
                for (var f = (b = w(b)); f.length > a.CHARACTER_LIMIT; ) {
                  ...
                  if (-1 == e || e >= a.CHARACTER_LIMIT)
                    e = f.search(/,[^0-9]+/);
                  if (
                    (-1 == e || e >= a.CHARACTER_LIMIT) &&
                    -1 != f.search(" ")
                  ) {
                    var u = f.split(" ");
                    for (e = 0; e < u.length; e++) {
                      if (l.length + u[e].length + 1 > a.CHARACTER_LIMIT) {
                        u[e].length >= a.CHARACTER_LIMIT &&
                          (l += u[e].substr(
                            0,
                    ...
                    a.log("Using SpeechSynthesis"),
                      ...
                      null != d
                        ? ((f.voice =
                          ...
                          (f.rate = a.iOS
                            ? (null != d.rate ? d.rate * d.rate : 1) * f.rate
                            : (null != d.rate ? d.rate : z) * f.rate),
      ...
      a.numToWords = function (b) {
        var c = (function () {
          ...
          F = function (m) {
            ...
            v = v[2];
            return [
              0 === (Number(v) || 0) ? "" : u[v] + " hundred ",
              0 === (Number(m) || 0) ? D[n] : (D[n] && D[n] + " ") || "",
              u[n + m] || u[m],
            ].join("");
          },
          x = function (m, v) {
